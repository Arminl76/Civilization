...
public class WakeUnitMenuAction extends AbstractMenuAction<EmptyCmdLoader> {

    public static final WakeUnitMenuAction INSTANCE = new WakeUnitMenuAction();

    private WakeUnitMenuAction() {
    }
