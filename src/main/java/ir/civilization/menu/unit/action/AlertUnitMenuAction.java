...
public class AlertUnitMenuAction extends AbstractMenuAction<EmptyCmdLoader> {

    public static final AlertUnitMenuAction INSTANCE = new AlertUnitMenuAction();

    private AlertUnitMenuAction() {
    }
    ...
    public void takeAction(EmptyCmdLoader v) {
        ...
        System.out.println("unit was alerted successfully!");
    }
